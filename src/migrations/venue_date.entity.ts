...
export class VenueDate extends BaseEntity {
  ...
  @ManyToOne(() => ElementTop, (element_top) => element_top.venue_date_left, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_top_left_id' })
  public element_top_left!: ElementTop;

  @ManyToOne(() => ElementTop, (element_top) => element_top.venue_date_right, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_top_right_id' })
  public element_top_right!: ElementTop;

  @ManyToOne(() => ElementBot, (element_bot) => element_bot.venue_date_left, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_bot_left_id' })
  public element_bot_left!: ElementBot;

  @ManyToOne(() => ElementBot, (element_bot) => element_bot.venue_date_right, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_bot_right_id' })
  public element_bot_right!: ElementBot;

  @ManyToOne(() => Background, (background) => background.venue_date, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'background_id' })
  public background!: Background;

  @ManyToOne(() => Frame, (frame) => frame.venue_date, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'frame_id' })
  public frame!: Frame;

  @ManyToOne(() => Animation, (animation) => animation.venue_date, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'animation_id' })
  public animation!: Animation;

  @ManyToOne(() => Color, (color) => color.venue_date, {
    onDelete: 'CASCADE'
  })
