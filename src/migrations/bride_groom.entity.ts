...
export class BrideGroom extends BaseEntity {
  ...
  @ManyToOne(() => ElementTop, (element_top) => element_top.bride_groom_left, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_top_left_id' })
  public element_top_left!: ElementTop;

  @ManyToOne(() => ElementTop, (element_top) => element_top.bride_groom_right, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_top_right_id' })
  public element_top_right!: ElementTop;

  @ManyToOne(() => ElementBot, (element_bot) => element_bot.bride_groom_left, {
    onDelete: 'CASCADE'
  })
  @JoinColumn({ name: 'element_bot_left_id' })
  public element_bot_left!: ElementBot;

  @ManyToOne(() => ElementBot, (element_bot) => element_bot.bride_groom_right, {
    onDelete: 'CASCADE'
  })
  ...
  @ManyToOne(() => Font, (font) => font.bride_groom, {
    onDelete: 'CASCADE'
  })
